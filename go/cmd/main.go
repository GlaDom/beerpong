...
func main() {
	...
	v1 := router.Group("/api/v1")
	{
		...
		v1.PUT("/updateMatchesRoundOfSixteen", beerpongGameHandler.UpdateMatchesRoundOfSixteen)
		v1.PUT("/updateMatchesQuaterfinals", beerpongGameHandler.UpdateGameQuaterFinals)
		v1.PUT("/updateMatchesSemifinals", beerpongGameHandler.UpdateGameSemiFinals)
		v1.PUT("/updateMatchesFinal", beerpongGameHandler.UpdateGameSemiFinals)
