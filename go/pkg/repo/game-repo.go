...
// 	matches := gr.calculateMatchesPerGroup(game.Game.Teams, game.Game.ID, game.Game.Referee, game.Game.StartTime, game.Game.GameTime)
// 	if tx := gr.db.Create(&matches); tx.Error != nil {
// 		return tx.Error
// 	}
// 	return nil
...
// func (gr *Gamerepo) calculateMatchesPerGroup(teams []models.Team, gameId int, referees []models.Referee, startTime time.Time, playTime time.Duration) []models.Match {
